...
def read_mirbase_file(mirbase_file, organism_prefix=None):
...
def insert_mirna(in_df, mirbase_file, col_name, organism_prefix=None):
    def find_mrna(row):
    ...
    miRBase_dic = read_mirbase_file(mirbase_file, organism_prefix)
